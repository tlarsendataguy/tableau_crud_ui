...
main(){
  ...
  test("Test json generated to update record",(){
    ...
    var requestJson = request.toJson();
    expect(requestJson, equals('{"Server":"server","Port":"port","Username":"username","Password":"password","Database":"test","Schema":"dbo","Table":"some_table","Function":"Update","Parameters":{"where":[{"field":"field1","operator":"equals","values":[10]}],"updates":{"field1":"A","field2":123}}}'));
    print(requestJson);
  });
  ...
  test("Test json generated to read records",(){
    ...
    var requestJson = request.toJson();
    expect(requestJson, equals('{"Server":"server","Port":"port","Username":"username","Password":"password","Database":"test","Schema":"dbo","Table":"some_table","Function":"Read","Parameters":{"fields":["field1","field2"],"where":[{"field":"field1","operator":"equals","values":[10]}],"orderBy":["field1"],"pageSize":10,"page":1}}'));
    print(requestJson);
  });
}