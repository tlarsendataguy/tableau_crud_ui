...
main(){
  ...
  test("Test from JSON when empty",(){
    ...
    expect(settings.toJson(), equals('{"apiKey":"","connection":"","table":"","selectFields":{},"orderByFields":[],"primaryKey":[],"filters":[],"defaultPageSize":10,"mappedDataSources":[],"tableColumns":[],"enableInsert":false,"enableUpdate":false,"enableDelete":false}'));
